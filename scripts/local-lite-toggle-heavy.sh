...
FILES="kafka-operator.yaml kafka-cluster.yaml spark-operator.yaml airflow.yaml airflow-db-init.yaml seatunnel.yaml trino.yaml superset.yaml superset-db-init.yaml opensearch.yaml openmetadata.yaml openmetadata-db-init.yaml mlflow.yaml mlflow-db-init.yaml"

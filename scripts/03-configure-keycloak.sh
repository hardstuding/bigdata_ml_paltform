...
create_client_if_absent openbao '["http://openbao.local-lite.test/ui/vault/auth/oidc/oidc/callback","http://openbao.local-lite.test:32460/ui/vault/auth/oidc/oidc/callback","http://localhost:8250/oidc/callback"]' openbao openbao-oidc-secret clientSecret

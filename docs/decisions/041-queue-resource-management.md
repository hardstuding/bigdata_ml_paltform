...
> **2026-08-23 后续补充**:这份 ADR 的 ResourceQuota 管的是"**单个组件**
> 失控时别拖死机器",是保护性上限。"**哪个组**能用多少计算资源、闲时能不能
> 借别人的"是另一件事,由 [ADR-064](064-role-based-resource-quota.md) 的
> Kueue 队列负责。两层并存,不是替换关系——看这份时别以为配额问题已经全解决了。
